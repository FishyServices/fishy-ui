...
declare const PopoverPositioner: React.ForwardRefExoticComponent<Omit<import("@base-ui/react").PopoverPositionerProps, "ref"> & React.RefAttributes<HTMLDivElement>>;
