...
const Card = React.forwardRef(({ className, ...props }, ref) => (_jsx("div", { ref: ref, className: cn("rounded-xl border border-border/35 bg-card text-card-foreground shadow-none", className), ...props })));
